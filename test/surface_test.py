...
class GeneralSurfaceTests(AssertRaisesRegexMixin, unittest.TestCase):
    ...
    def test_src_alpha_sdl2_blitter(self):
        ...
        results_expected = {
            ((0, 255, 255), (0, 255, 0)): ((0, 255, 255, 255),),
            ((0, 255, 255), (1, 254, 1)): ((0, 253, 253, 253), (0, 255, 254, 254)),
            ((0, 255, 255), (65, 199, 65)): ((16, 253, 239, 253), (16, 255, 240, 254)),
            ((0, 255, 255), (126, 127, 126)): ((62, 253, 190, 253), (62, 255, 192, 254)),
            ((0, 255, 255), (127, 126, 127)): ((63, 253, 189, 253), (63, 255, 191, 254)),
            ((0, 255, 255), (199, 65, 199)): ((154, 253, 105, 253), (154, 255, 107, 254)),
            ((0, 255, 255), (254, 1, 254)): ((252, 253, 0, 253), (252, 255, 2, 254)),
            ((0, 255, 255), (255, 0, 255)): ((255, 255, 0, 255),),
            ((1, 254, 254), (0, 255, 0)): ((1, 255, 254, 254),),
            ((1, 254, 254), (1, 254, 1)): ((0, 253, 252, 252), (1, 255, 254, 253)),
            ((1, 254, 254), (65, 199, 65)): ((16, 253, 238, 252), (17, 255, 240, 253)),
            ((1, 254, 254), (126, 127, 126)): ((62, 253, 189, 252), (62, 255, 191, 253)),
            ((1, 254, 254), (127, 126, 127)): ((63, 253, 189, 253), (63, 255, 190, 254)),
            ((1, 254, 254), (199, 65, 199)): ((154, 253, 105, 253), (154, 255, 107, 254)),
            ((1, 254, 254), (254, 1, 254)): ((252, 253, 0, 253), (252, 255, 2, 254)),
            ((1, 254, 254), (255, 0, 255)): ((255, 255, 0, 255),),
            ((65, 199, 199), (0, 255, 0)): ((65, 255, 199, 199),),
            ((65, 199, 199), (1, 254, 1)): ((64, 253, 197, 197), (64, 255, 199, 198)),
            ((65, 199, 199), (65, 199, 65)): ((64, 253, 197, 211), (65, 255, 199, 212)),
            ((65, 199, 199), (126, 127, 126)): ((94, 253, 162, 225), (95, 255, 163, 226)),
            ((65, 199, 199), (127, 126, 127)): ((95, 253, 161, 225), (95, 255, 162, 226)),
            ((65, 199, 199), (199, 65, 199)): ((168, 253, 93, 241), (169, 255, 94, 242)),
            ((65, 199, 199), (254, 1, 254)): ((252, 253, 0, 253), (252, 255, 2, 254)),
            ((65, 199, 199), (255, 0, 255)): ((255, 255, 0, 255),),
            ((126, 127, 127), (0, 255, 0)): ((126, 255, 127, 127),),
            ((126, 127, 127), (1, 254, 1)): ((125, 253, 126, 126), (125, 255, 127, 127)),
            ((126, 127, 127), (65, 199, 65)): ((109, 253, 144, 158), (110, 255, 145, 159)),
            ((126, 127, 127), (126, 127, 126)): ((125, 253, 125, 188), (126, 255, 127, 189)),
            ((126, 127, 127), (127, 126, 127)): ((126, 253, 125, 189), (126, 255, 126, 190)),
            ((126, 127, 127), (199, 65, 199)): ((181, 253, 77, 225), (182, 255, 78, 226)),
            ((126, 127, 127), (254, 1, 254)): ((252, 253, 0, 253), (253, 255, 1, 254)),
            ((126, 127, 127), (255, 0, 255)): ((255, 255, 0, 255),),
            ((127, 126, 126), (0, 255, 0)): ((127, 255, 126, 126),),
            ((127, 126, 126), (1, 254, 1)): ((126, 253, 125, 125), (126, 255, 126, 126)),
            ((127, 126, 126), (65, 199, 65)): ((110, 253, 143, 157), (111, 255, 144, 158)),
            ((127, 126, 126), (126, 127, 126)): ((125, 253, 125, 188), (126, 255, 126, 189)),
            ((127, 126, 126), (127, 126, 127)): ((126, 253, 125, 189), (127, 255, 126, 190)),
            ((127, 126, 126), (199, 65, 199)): ((181, 253, 77, 225), (182, 255, 78, 226)),
            ((127, 126, 126), (254, 1, 254)): ((252, 253, 0, 253), (253, 255, 1, 254)),
            ((127, 126, 126), (255, 0, 255)): ((255, 255, 0, 255),),
            ((199, 65, 65), (0, 255, 0)): ((199, 255, 65, 65),),
            ((199, 65, 65), (1, 254, 1)): ((197, 253, 64, 64), (198, 255, 65, 65)),
            ((199, 65, 65), (65, 199, 65)): ((163, 253, 98, 112), (164, 255, 99, 113)),
            ((199, 65, 65), (126, 127, 126)): ((162, 253, 94, 157), (163, 255, 95, 158)),
            ((199, 65, 65), (127, 126, 127)): ((162, 253, 94, 158), (163, 255, 95, 159)),
            ((199, 65, 65), (199, 65, 199)): ((197, 253, 64, 212), (199, 255, 65, 213)),
            ((199, 65, 65), (254, 1, 254)): ((252, 253, 0, 253), (253, 255, 1, 254)),
            ((199, 65, 65), (255, 0, 255)): ((255, 255, 0, 255),),
            ((254, 1, 1), (0, 255, 0)): ((254, 255, 1, 1),),
            ((254, 1, 1), (1, 254, 1)): ((252, 253, 0, 0), (253, 255, 1, 1)),
            ((254, 1, 1), (65, 199, 65)): ((204, 253, 50, 64), (206, 255, 51, 65)),
            ((254, 1, 1), (126, 127, 126)): ((189, 253, 62, 125), (191, 255, 63, 126)),
            ((254, 1, 1), (127, 126, 127)): ((190, 253, 62, 126), (190, 255, 63, 127)),
            ((254, 1, 1), (199, 65, 199)): ((209, 253, 50, 198), (211, 255, 50, 199)),
            ((254, 1, 1), (254, 1, 254)): ((252, 253, 0, 253), (254, 255, 1, 254)),
            ((254, 1, 1), (255, 0, 255)): ((255, 255, 0, 255),),
            ((255, 0, 0), (0, 255, 0)): ((255, 255, 0, 0),),
            ((255, 0, 0), (1, 254, 1)): ((253, 253, 0, 0), (254, 255, 0, 1)),
            ((255, 0, 0), (65, 199, 65)): ((205, 253, 50, 64), (206, 255, 50, 65)),
            ((255, 0, 0), (126, 127, 126)): ((190, 253, 62, 125), (191, 255, 62, 126)),
            ((255, 0, 0), (127, 126, 127)): ((190, 253, 62, 126), (191, 255, 62, 127)),
            ((255, 0, 0), (199, 65, 199)): ((209, 253, 50, 198), (211, 255, 50, 199)),
            ((255, 0, 0), (254, 1, 254)): ((252, 253, 0, 253), (254, 255, 0, 254)),
            ((255, 0, 0), (255, 0, 255)): ((255, 255, 0, 255),)
        }
        ...
        for dst_r, dst_b, dst_a in zip(nums, reversed(nums), reversed(nums)):
            for src_r, src_b, src_a in zip(nums, reversed(nums), nums):
                with self.subTest(
                    ...
                    self.assertTrue(results[key] in results_expected[key])
